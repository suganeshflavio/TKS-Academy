    ...
    >
      {student == null ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          <Card style={{ borderRadius: 10, padding: 20 }}>
            <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
              ...
              <div style={{ minWidth: 240 }}>
                ...
                <br />
                <Text strong>Enrollment:</Text> <Text>{student.enrollmentDate}</Text>
                <br />
                <Text strong>Last Active:</Text> <Text>{student.lastActive}</Text>
              </div>
              <div style={{ minWidth: 240 }}>
                <Text strong>Attendance:</Text> <Text>{student.attendance}</Text>
                <br />
          ...
          <Card title="Available Courses" style={{ borderRadius: 10, padding: 20 }}>
            <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
              {student.availableCourses.map((course) => (
                ...
                >
                  ...
                  <Tag color={getCourseTagColor(course.access)}>{course.access}</Tag>
                  <div style={{ marginTop: 12 }}>
                    <Text type="secondary">Progress</Text>
                    <Progress percent={course.progress} size="small" style={{ width: "100%" }} />
                  </div>
                  <Text type="secondary">Last accessed {course.lastAccess}</Text>
                </Card>
              ))}
            </div>
          </Card>

          <Card title="Session History" style={{ borderRadius: 10, padding: 20 }}>
            <Table
          ...
          <Card title="Student Report" style={{ borderRadius: 10, padding: 20 }}>
